...
Dies ist Version **0.2.1**. Die App verwendet bewusst noch Demodaten und speichert Änderungen bis zum Neustart der App im Arbeitsspeicher. Sie ist noch nicht für den produktiven Einsatz bestimmt.
